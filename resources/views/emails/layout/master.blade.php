                                        ...
                                        <tr>
                                            <td style="font-size:0;padding:0px;" align="center">
                                                <div class="mj-content" style="cursor:auto;color:#6b7a85;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;">
                                                    ...
                                                    Address: Canadia Tower 18th Floor #315, Monivong Blvd, Ang Doung Street, Phnom Penh 12202, Cambodia. <br />
                                                    E-mail:<span style="border-bottom: solid 1px #b3bac1">support@gcfinvestment.com</span><br />
                                                    Website:  <a href="#" style="text-decoration: none; color: inherit;"> <span style="border-bottom: solid 1px #b3bac1">www.gcfinvestment.com</span> </a>
                                                  </div>
                                            </td>
                                        </tr>
                                    </tbody>
