 ...
 <tbody>
    <tr>
        <td style="font-size:0;padding:30px 30px 18px;" align="left">
            <div class="mj-content" style="cursor:auto;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:24px;line-height:22px;"> Deposit Request Approve</div>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="font-size:0;padding:0 30px 16px;" align="left">
            <div class="mj-content" style="cursor:auto;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;">
              ...
              <p>
               You request to deposite money with following information <br />
               Amount: {{$data['amount']}}.00 USD <br />
               Date: {{$data['date']}} <br />
                has been rejected. Please contact us for more detail. 
              </p>
          </div>
        </td>
    </tr>
